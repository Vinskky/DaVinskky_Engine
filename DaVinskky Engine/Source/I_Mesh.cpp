...
bool Mesh::LoadVertex(const aiMesh* mesh)
{
...
bool Mesh::LoadIndex(const aiMesh* mesh)
{
	if (!mesh->HasFaces())
	{
...
bool Mesh::LoadTextCoords(const aiMesh* mesh)
{
...
bool Mesh::LoadNormals(const aiMesh* mesh)
{
	if (!mesh->HasNormals())
	{
